...
**Plans**: 6 plans in 5 waves — local Waves 1 and 2, source publication, bootstrap byte approval and exact one-attempt publication authority are complete. No publication was attempted; the latest authentication renewal stopped on a non-browser credential prompt and requires scoped recovery.
**Wave 1**
...
| 5. Bootstrap & Trusted Stable Publication | 3/6 | Authorized bootstrap, renewal recovery | - |
