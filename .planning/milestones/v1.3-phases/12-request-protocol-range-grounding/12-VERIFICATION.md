...
| 14 | An identical range scope resumes its immutable provenance. | ✓ VERIFIED | `sameDraftComparison()` cumpas every scope field in order; draft-load/API tests prove matching-scope resume. |
