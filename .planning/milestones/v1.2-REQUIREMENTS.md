...
- [x] **PICK-01**: User can interact with the ordered source picker before Cumpa enumerates all remaining local branches.
...
- **PERF-03**: User receives sub-500 ms first-search results in repositories containing 10,000 loose local branch refs without Cumpa mutating repository state.
