...
| --- | --- | --- | --- | --- |
| PICK-01 | `09-01-PLAN.md`, `09-02-PLAN.md` | User can interact with the ordered source picker before Cumpa enumerates all remaining local branches. | ✓ SATISFIED | Eager discovery has no unbounded local-ref command; empty picker requests render immediately; focused Git and CLI interaction contracts passed. |
