export const CANONICAL_TOKENS = [
  '--border-control', '--border-default', '--border-gap', '--border-hunk', '--border-width-default',
  ...
  '--diff-unchanged-background', '--focus-offset', '--focus-outline-width', '--focus-ring', '--font-mono',
  ...
  '--line-height-metadata', '--line-height-page-heading', '--monaco-inactive-selection-background',
  ...
  '--selection-background', '--selection-border', '--shadow-overlay', '--space-1', '--space-2', '--space-4',
  '--space-6', '--space-8', '--status-disabled-background', '--status-disabled-foreground',
  '--status-error-background', '--status-error-foreground', '--status-information-background',
  '--status-information-foreground', '--status-pending-background', '--status-pending-foreground',
  '--status-resolved-background', '--status-resolved-foreground', '--status-success-background',
  '--status-success-foreground', '--status-warning-background', '--status-warning-foreground', '--surface-canvas',
  '--surface-empty', '--surface-hunk', '--surface-interactive', '--surface-interactive-active',
