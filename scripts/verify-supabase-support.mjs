...
async function verifyWorkflow(path, options) {
  ...
  const required = [
    ...
    'npm ci', 'npm run build', 'npx playwright install --with-deps chromium', 'npx vitest run --no-file-parallelism', 'npx playwright test tests/e2e/support-payment.spec.ts tests/e2e/support-restore.spec.ts', 'deno test --allow-env --config supabase/functions/deno.json supabase/functions/tests',
  ...
  for (const value of ['npm ci', 'npm run build', 'npx playwright install --with-deps chromium', 'npx vitest run --no-file-parallelism', 'npx playwright test tests/e2e/support-payment.spec.ts tests/e2e/support-restore.spec.ts', 'deno test --allow-env --config supabase/functions/deno.json supabase/functions/tests', 'npx supabase@2.114.0 db start', 'npx supabase@2.114.0 db reset --local --no-seed', 'npx supabase@2.114.0 test db', 'npx supabase@2.114.0 migration list --local', 'npx supabase@2.114.0 db lint --local']) {
